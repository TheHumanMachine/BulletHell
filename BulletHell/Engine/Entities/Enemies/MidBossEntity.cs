...
{
    public class MidBossEntity : BaseEntity
    {
        ...
        public MidBossEntity(Texture2D entitySprite, float x, float y, double movementSpeed, AbstractMovementPattern[] movementPatterns, float scalar) : base(entitySprite, x, y, movementSpeed, scalar)
        {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (!hasTimeStarted && bossTimer > TimeSpan.FromSeconds(30)) 
            {
